    ...
    <div>
        <div class="col-12 p-0">
            ...
            <div class="customBorderBottom row py-3 textGrey"
                ...
                <div class="col-2 pr-0">
                    <div class="row">
                        ...
                        <div class="col-6 pr-0">
                            <router-link class="row pl-2" :to="{ name: 'ContactEdit', params: {user_id: contact.id } }">
                ...
                <div class="col-10">
                    <router-link class="row routerLink linkDisabled textGrey" :to="{ name: 'ContactEdit', params: {user_id: contact.id} }">
